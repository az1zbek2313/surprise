    ...
    <div className="border-t-[1.5px] py-2 border-gray-300">
      <div className={`${styles.container} px-8 xs:px-16 flex justify-between items-start flex-wrap gap-3`}>
        <ul className="w-[47%] sm:w-auto">
          <li className="font-semibold text-sm md:text-base mb-2">About</li>
        ...
        <ul className="w-[47%] sm:w-auto">
          <li className="font-semibold text-sm md:text-base mb-2">Category</li>
          <li className="text-sm text-gray-500">
        ...
        <ul className="w-[47%] sm:w-auto">
          <li className="font-semibold text-sm md:text-base mb-2">Users</li>
          <li className="text-sm text-gray-500">
        ...
        <ul className="w-[47%] sm:w-auto">
          <li className="font-semibold text-sm md:text-base mb-2">For Entrepreneurs</li>
          <li className="text-sm text-gray-500">
