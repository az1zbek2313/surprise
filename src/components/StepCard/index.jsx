...
function StepCard({ data }) {
  return (
    <div className=" w-[33%] rounded-lg md:rounded-xl h-full border sm:border-[3px] shadow-sm px-2 xs:px-3 md:px-4 lg:px-7 xl:px-8 py-1 pb-2 xs:py-3 lg:py-5 yl:py-6 flex flex-col items-center gap-[2px] sm:gap-2 lg:gap-[18px]">
